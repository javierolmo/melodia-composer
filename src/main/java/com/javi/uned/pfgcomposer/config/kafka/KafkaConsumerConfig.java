...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ScoreSpecs> specsConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(ScoreSpecs.class));
    }
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ScoreSpecs> specsKafkaListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ScoreSpecs> factory = new ConcurrentKafkaListenerContainerFactory<>();
